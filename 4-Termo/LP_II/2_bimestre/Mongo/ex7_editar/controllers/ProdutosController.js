...
module.exports = class ProdutosController{
    ...
    static async editarProtudo(req, resp){
        const id = req.params.id
        //utilizar o get produto
        const produto = await Produtos.getProdutoByID(id)

        resp.render('produtos/editar', {produto})

    }


    //método salvar produto
    static async salvarProduto(req, resp){

        //receber as informações do body
        ...
        //metodo do banco
        await produto.salvarProdutoBD(id)
